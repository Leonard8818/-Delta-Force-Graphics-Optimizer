...
发布清单可声明最低支持版本。支持该字段的 v0.19.0 及以后客户端低于该值时，更新窗口不提供跳过或稍后选项，必须升级后才能继续使用；最低支持版本保持 v0.20.4，因此 v0.20.4 稳定版不会被强制升级到 v0.21.0。更早客户端仍会收到普通更新提示，官网同时保留最新版和 v0.20.4 稳定版安装包。
