...
Assert-True ($raw.Contains("`$script:GuiVersion = '0.23.0.1'") -and
    $raw.Contains("`$script:DisplayVersion = '0.23.0.1'") -and
    $raw.Contains('Text="[ v0.23.0.1 ]"')) `
  'the unified v0.23.0.1 version is missing or inconsistent'
