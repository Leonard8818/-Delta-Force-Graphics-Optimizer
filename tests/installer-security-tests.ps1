...
Assert-True ($installerBuildSource -match "minimumSupportedVersion\s*=\s*'0\.21\.6'" -and
  "$($releaseManifest.version)" -eq '0.22.2' -and "$($releaseManifest.minimumSupportedVersion)" -eq '0.21.6') `
  'release policy must force versions below v0.21.6 to upgrade to v0.22.2 while keeping v0.21.6 optional'
